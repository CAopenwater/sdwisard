...
For example, Alameda County Water District is PSID 110001:  

```{r}
alameda_all <- get_data(psid = "110001")
glimpse(alameda_all)
```
...
```{r}
alameda_nitrate <- get_data(psid = "110001", storet = "A-029")
```
...
```{r}
alameda_09_2018 <- get_data(psid = "110001", start_date = "2018-09-01", end_date = "2018-09-30")
```
